...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
The assigned value for prob\_close was determined through trial and error and proved to provide the best results (figure-\ref{rggs:521v1} and figure-\ref{rggs:521v2}). 
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \label{rggs:p25}
    \end{minipage} \hfill
    \caption{Ring Group Graph parameters: q = 0.05}
    \label{rggs:p}
\end{figure}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \subcaption{Search Time Distribution with changing k}
        \label{rggs:125v2}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{{box/box-ring_group_graph-50-20-10-search_time_v2-avg}.png}
        \subcaption{Search Time Distribution with changing m}
        \label{rggs:521v22}
    \end{minipage} \hfill
